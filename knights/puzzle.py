...
base = And(Or(AKnight, AKnave), Or(BKnave, BKnight), Or(CKnight, CKnave),
           Biconditional(AKnight, Not(AKnave)), Biconditional(BKnight, Not(BKnave)), Biconditional(CKnight, Not(CKnave)))
...
knowledge2 = And(
    ...
    Biconditional(Biconditional(AKnight, BKnave), BKnight)
)
knowledge2.add(base)
